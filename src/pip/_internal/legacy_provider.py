from pip._vendor.resolvelib.provider import AbstractProvider
...
class LegacyProvider(AbstractProvider):
    def __init__(
        self,
    ...
    def _get_installed_distribution(self, requirement):
        pass

    def _handle_installed(self, distribution, requirement):
        pass
    ...
    def find_matches(self, requirement):
        ...
        """
        distribution = self._get_installed_distribution(requirement)
